...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 20, 761, 304))
        ...
        self.startToner = QtWidgets.QPushButton(self.frame_3)
        font = QtGui.QFont()
        font.setFamily("Open Sans")
        font.setPointSize(16)
        self.startToner.setFont(font)
        self.startToner.setObjectName("startToner")
        self.horizontalLayout_3.addWidget(self.startToner)
        ...
        self.startToner.clicked.connect(MainWindow.startTonerClicked)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.startToner.setText(_translate("MainWindow", "Start Test"))
