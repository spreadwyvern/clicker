...
*Another more sophisticated way to control the relay by the PC is through USB HID interface but this requires further time and effort in digging into the HID report used by the control box*
