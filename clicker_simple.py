...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # # this adds small icon in the button
        # self.startTest.setIcon(QtGui.QIcon('record_button.png'))

        self.startTest = PicButton('start.png', 'start_hover.png', 'start_click.png', self.frame_3)
        # font = QtGui.QFont()
        # font.setFamily("Open Sans")
        # font.setPointSize(16)
        # self.startTest.setFont(font)
        ...
        self.endTest = PicButton('stop.png', 'stop_hover.png', 'stop_click.png', self.frame_3)
        font = QtGui.QFont()
        font.setFamily("Open Sans")
        font.setPointSize(16)
